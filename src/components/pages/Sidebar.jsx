    ...
    <div className="sidebar">
      ...
      <div className="list-group list-group-flush">
        <NavLink to="/usuarios" className="list-group-item list-group-item-action bg-dark">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-people-fill mr-2" viewBox="0 0 16 16">
        ...
        <NavLink to="/ventas" className="list-group-item list-group-item-action bg-dark ">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-currency-dollar mr-2" viewBox="0 0 16 16">
        ...
        <NavLink to="/productos" className="list-group-item list-group-item-action bg-dark">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-box-seam mr-2" viewBox="0 0 16 16">
